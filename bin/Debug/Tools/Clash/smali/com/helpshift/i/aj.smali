.class public final Lcom/helpshift/i/aj;
...
.method public static a(Ljava/lang/String;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    const-string v1, "show-agent-name"

    const/4 v8, 0x1

    invoke-virtual {v11, v1, v8}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z
    ...
    iput-object v1, v0, Lcom/helpshift/f/b;->b:Ljava/util/List;
...
.method public static a(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    iget-object v5, v0, Lcom/helpshift/f/c;->a:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v4, "id"

    iget-object v5, v0, Lcom/helpshift/f/c;->b:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v4, "body"

    iget-object v5, v0, Lcom/helpshift/f/c;->c:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v4, "origin"

    iget-object v5, v0, Lcom/helpshift/f/c;->d:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v4, "type"

    iget-object v5, v0, Lcom/helpshift/f/c;->e:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v4, "created_at"

    iget-object v5, v0, Lcom/helpshift/f/c;->f:Ljava/lang/String;
    ...
    iget-object v6, v0, Lcom/helpshift/f/c;->g:Ljava/lang/String;
    ...
    iget-object v6, v0, Lcom/helpshift/f/c;->h:Ljava/lang/String;
    ...
    iget-object v5, v0, Lcom/helpshift/f/c;->i:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v4, "seen"

    iget-boolean v5, v0, Lcom/helpshift/f/c;->j:Z

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    const-string v4, "invisible"

    iget-boolean v5, v0, Lcom/helpshift/f/c;->k:Z

    invoke-virtual {v3, v4, v5}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    const-string v4, "in_progress"

    iget-boolean v0, v0, Lcom/helpshift/f/c;->l:Z
